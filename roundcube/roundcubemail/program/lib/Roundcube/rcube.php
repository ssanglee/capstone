...
//smtp_headers 
	...
	//$sent = $this->smtp->send_mail($from, $a_recipients, $smtp_headers, $this->bound,null);
        if (is_resource($msg_body)) { // not passing here
            fclose($msg_body);
        }
